...
export const EtherInput = ({
  ...
  return (
    <InputBase
      ...
      disabled={disabled}
      prefix={
        <span className="pl-4 -mr-2 text-blue-600 font-semibold self-center">
          {displayUsdMode ? "$" : "Ξ"}
        </span>
      }
      suffix={
        ...
        >
          <button
            className="h-[2.2rem] min-h-[2.2rem] px-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
