...
export const ARBKPContractAddress = externalContracts[421614].HyperHarvest.address;
export const ARBKPContractABI = externalContracts[421614].HyperHarvest.abi;
export const OPKPContractAddress = externalContracts[11155420].HyperHarvest.address;
export const OPKPContractABI = externalContracts[11155420].HyperHarvest.abi;
